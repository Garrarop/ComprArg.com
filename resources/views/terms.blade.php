@extends('layouts.app')
@section('title')
  <title>Términos y condiciones - comprarg.com</title>
...
@section('content')
  <div class="container">
    ...
    <p><strong>LICENCIA</strong></p><p>COMPRARG.COM&nbsp; a través de su sitio web concede una licencia para que los usuarios utilicen&nbsp; los productos que son vendidos en este sitio web de acuerdo a los Términos y Condiciones que se describen en este documento.</p>
    ...
    <p>– De acuerdo a las especificaciones técnicas indicadas para cada producto.<br>– En condiciones ambientales acorde con las especificaciones indicadas por el fabricante.<br>
      ...
      <p>COMPRARG.COM reserva los derechos de cambiar o de modificar estos términos sin previo aviso.</p>
